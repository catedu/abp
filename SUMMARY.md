...
* [El Aprendizaje basado en Proyectos](el_aprendizaje_basado_en_proyectos.md0.md)
    * [¿Qué es, cómo es, dónde está?](que_es_como_es_donde_esta.md)
        ...
        * [Una definición de ABP](una_definicion_de_abp.md)
...
* [Apertura del aula en los proyectos: socialización y TIC](apertura_del_aula_en_los_proyectos_socializacion_y_tic.md2.md)
    ...
    * [Movimiento en el aula: aprendizaje cooperativo](movimiento_en_el_aula_aprendizaje_cooperativo.md)
        * [Definición de aprendizaje cooperativo](definicion_de_aprendizaje_cooperativo.md)
        * [Principios fundamentales](principios_fundamentales.md)
        * [Cuestiones prácticas](cuestiones_practicas.md)
        * [Las TIC al servicio del aprendizaje cooperativo](las_tic_al_servicio_del_aprendizaje_cooperativo.md)
        * [Para saber más sobre aprendizaje cooperativo](para_saber_mas_sobre_aprendizaje_cooperativo.md)
    * [Movimiento hacia fuera del aula: investigación de campo y aprendizaje-servicio](movimiento_hacia_fuera_del_aula_investigacion_de_campo_y_aprendizaje-servicio.md)
        * [La investigación de campo](la_investigacion_de_campo.md)
        * [Requisitos y pasos fundamentales](requisitos_y_pasos_fundamentales.md)
        * [El ciclo de investigación](el_ciclo_de_investigacion.md)
        * [El aprendizaje-servicio](el_aprendizaje-servicio.md)
...
* [Apertura del aula en los proyectos: socialización y TIC](apertura_del_aula_en_los_proyectos_socializacion_y_tic.md3.md)
    ...
    * [Movimiento hacia dentro del aula: comunidad de aprendizaje](movimiento_hacia_dentro_del_aula_comunidad_de_aprendizaje.md)
        * [Definición de comunidad de aprendizaje: comunidad abierta](definicion_de_comunidad_de_aprendizaje_comunidad_abierta.md)
        * [Cuestiones prácticas](cuestiones_practicas.md3.md)
...
* [La evaluación en el ABP](la_evaluacion_en_el_abp.md4.md)
    ...
    * [Un ejemplo de (co)evaluación formativa](un_ejemplo_de_coevaluacion_formativa.md)
    * [Evaluación por competencias](evaluacion_por_competencias.md)
        * [Marco normativo](marco_normativo.md)
        * [Evaluar competencias es evaluar los desempeños y sus dimensiones](evaluar_competencias_es_evaluar_los_desempenos_y_sus_dimensiones.md)
...
* [Mecanismos de evaluación](mecanismos_de_evaluacion.md5.md)
    ...
    * [Rúbricas](rubricas.md)
        * [Definición y uso](definicion_y_uso.md)
        * [Banco de rúbricas](banco_de_rubricas.md)
    * [La diana de evaluación](la_diana_de_evaluacion.md)
    * [Portafolio o portfolio](portafolio_o_portfolio.md)
...
* [Aprendizaje basado en Proyectos en tu centro y en tu comunidad profesional de aprendizaje](aprendizaje_basado_en_proyectos_en_tu_centro_y_en_tu_comunidad_profesional_de_aprendizaje.md6.md)
    * [El centro como ecosistema](el_centro_como_ecosistema.md)
        ...
        * [Actividades de Inicio del Proyecto](actividades_de_inicio_del_proyecto.md)
        * [Actividades de Desarrollo del Proyecto](actividades_de_desarrollo_del_proyecto.md)
        * [Actividades de Finalización del Proyecto](actividades_de_finalizacion_del_proyecto.md)
...
* [La enseñanza basada en proyectos como proceso de capacitación y desarrollo profesional docente](la_enseñanza_basada_en_proyectos_como_proceso_de_capacitación_y_desarrollo_profesional_docente.md7.md)
    * [Análisis de las posibilidades de capacitación y desarrollo profesional vinculadas con el diseño de proyectos de aprendizaje](análisis_de_las_posibilidades_de_capacitación_y_desarrollo_profesional_vinculadas_con_el_diseño_de_proyectos_de_aprendizaje.md)
        ...
        * [El ABP como formación en centros](el_abp_como_formacion_en_centros.md)
